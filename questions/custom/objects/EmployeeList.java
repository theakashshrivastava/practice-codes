...
public class EmployeeList {
    public static List<Employee> getEmployees() {
        return Arrays.asList(
                ...
                new Employee(3, "Aman", 26, 110000, "M", "IT", "Mumbai"),
                ...
                new Employee(9, "Katrina", 23, 510000, "F", "BT", "Mumbai"),
                new Employee(10, "Ram", 51, 670000, "M", "ME", "Hyderabad"),
                new Employee(11, "Shyam", 23, 780000, "F", "ME", "Delhi"),
                new Employee(12, "Rupa", 47, 190000, "F", "ME", "Bangalore"),
                new Employee(12, "Pushpa", 27, 17000, "F", "CM", "Indore"),
                new Employee(12, "Mona", 27, 10000, "F", "CM", "Indore")
        );
    }
}
